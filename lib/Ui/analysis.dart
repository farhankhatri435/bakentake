...
class Analysis extends StatefulWidget {
  ...
  /*Analysis({this.assetPath, this.cookieprice, this.cookiename});*/
                ...
                child: Card(
                  child: Row(
                    children: <Widget>[
                      ...
                      Hero(
                          tag: 'assets/browniecookies.jpg',
                          child: Image.asset('assets/redvelvetcakecookie.jpeg',
                              height: 90.0, width: 90.0, fit: BoxFit.contain)),
                      SizedBox(width: 20.0),
                      Column(
                        children: <Widget>[
                ...
                child: Card(
                  child: Row(
                    children: <Widget>[
                      ...
                      Hero(
                          tag: 'assets/browniecookies.jpg',
                          child: Image.asset('assets/rainbowcakecookie.jpeg',
                              height: 90.0, width: 90.0, fit: BoxFit.contain)),
                      SizedBox(width: 20.0),
                      Column(
                        children: <Widget>[
